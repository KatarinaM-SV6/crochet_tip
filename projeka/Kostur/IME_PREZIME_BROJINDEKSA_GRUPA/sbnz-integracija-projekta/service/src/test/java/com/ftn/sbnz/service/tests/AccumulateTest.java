...
public class AccumulateTest {
    ...
    public void testInsertModifyAndDelete() {
        ...
        CrochetPeriod period1 = new CrochetPeriod(user, Duration.ofMinutes(20), LocalDate.now().minusDays(5)); 
        System.out.println("first " + LocalDate.now().minusDays(1));
        Duration d = Duration.ZERO;
        d = d.plus(period1.duration);
        System.out.println("second " + d.toMinutes());

        CrochetPeriod period2 = new CrochetPeriod(user, Duration.ofMinutes(2), LocalDate.now()); 
